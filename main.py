...
bot = Client(
    ...
    api_hash=API_HASH,
    bot_token=BOT_TOKEN)
auth_users = [7376514183,7372337682,5398544600,5744241317]
...
async def start(bot, update):
       await update.reply_text("Hi i am **physics wallah Downloader**.\n\n"
                              "**NOW:-** "
                                       ...
                                       "Press **/lp** to continue..\n\n")

@bot.on_message(filters.command(["lp"]))
async def account_login(bot: Client, m: Message):
    editable = await m.reply_text(
